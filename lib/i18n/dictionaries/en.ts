...
export const dictionary: Dictionary = {
    ...
    tiers: [
      {
        ...
        launchNote: "Live in 7-14 business days after payment",
      },
      {
        name: "GROW",
        tag: "To scale up",
  ...
  lossCalculator: {
    eyebrow: "Do the math yourself",
    heading: "How much you're theoretically missing out on",
    subtitle: "Enter your own numbers — the calculation uses only what you type, not our assumptions about the market.",
    callsLabel: "Calls/messages per week left unanswered",
    callsPlaceholder: "e.g. 10",
    valueLabel: "Average value per client, €",
    valuePlaceholder: "e.g. 150",
    shareLabel: "What share of those you lose completely",
    shareNote: "Your own estimate — feel free to change it",
    formulaLabel: "Formula: calls/messages per week × 4.33 × average value × (loss share / 100)",
    resultEmpty: "Enter your numbers above to see an estimate.",
    resultPrefix: "With these inputs, you're theoretically missing out on ≈",
    resultSuffix: "€ per month",
    disclaimer: "This isn't our statistic — it's a calculation based on the numbers and assumption you entered yourself.",
    ctaText: "This can be solved with an AI chatbot or voice agent that responds instantly.",
    ctaButton: "Discuss a solution",
  },
  trustBadges: {
    heading: "Why you can trust us",
    items: [
      "Officially registered with VID (Latvian State Revenue Service) as a self-employed person since 07.09.2026",
      "We work under a written contract with clear IP and liability terms",
      "GDPR-based Data Processing Agreement (DPA) available for every project",
    ],
    legalPrefix: "Publicly available",
    legalJoiner: " and ",
  },
  bigStatement: {
    line1: "One business.",
